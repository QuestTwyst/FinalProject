...
/**
 * Seeds the 5 newer stories (built during the React theming work) into
 * the real database, matching the same schema/pattern as reset.js.
 *
 * IMPORTANT: run this AFTER reset.js, since it relies on the base
 * tables (stories, passages, choices, genres, story_genres) already
 * existing. It does NOT drop or reset anything -- it only adds new
 * rows, and is safe to re-run (it checks for existing titles first).
 *
 * Since the real schema has no explicit "start passage" column, the
 * FIRST passage inserted for each story becomes its starting point --
 * this matches how reset.js already seeded "The Lost Forest".
 */
...
const seedStory = async (story) => {
  ...
  // Pass 1: insert every passage, in a stable order starting with the
  // story's actual start passage, and remember the real DB id for each.
  const idMap = {};
  ...
  // Pass 2: now that every passage has a real id, insert the choices.
  for (const localId of orderedIds) {
    const passage = story.passages[localId];
  ...
  console.log(`Seeded "${story.title}" - ${orderedIds.length} passages.`);
};
...
const stories = [
  {
    ...
    "passages": {
      "1": {
        ...
        "choices": [
          {
            "text": "Reach out to the old flame",
            "next": 2
          },
          {
            "text": "Choose peace instead",
            "next": 3
          }
        ]
      },
      "2": {
        ...
        "choices": [
          {
            "text": "Answer honestly about why you reached out now",
            "next": 4
          },
          {
            "text": "Keep the reply light and see where it goes",
            "next": 5
          }
        ]
      },
      "3": {
        ...
        "choices": [
          {
            "text": "Answer the knock",
            "next": 6
          },
          {
            "text": "Let the silence hold and stay inside",
            "next": 7
          }
        ]
      },
  ...
  },
  {
    ...
    "passages": {
      ...
      "2": {
        ...
        "choices": [
          {
            "text": "Offer to come with him to the wedding.",
            "next": 4
          },
          {
      ...
      "3": {
        ...
        "choices": [
          {
            "text": "Ask him now that you've made it to shore.",
            "next": 6
          },
          {
      ...
      "5": {
        ...
        "choices": [
          {
            "text": "Call the number the very next chance she gets.",
            "next": 10
          },
          {
      ...
      "6": {
        ...
        "choices": [
          {
            "text": "Offer to help him find a way to save it.",
            "next": 12
          },
          {
      ...
      "7": {
        ...
        "choices": [
          {
            "text": "Show up next week, ferry schedule be damned.",
            "next": 14
          },
          {
      ...
      "8": {
        ...
        "choices": [
          {
            "text": "Ask him to come visit her city next.",
            "next": 16
          },
          {
            "text": "Let tonight be enough, no promises attached.",
            "next": 17
          }
        ]
      },
      "9": {
        ...
        "choices": [
          {
            "text": "Let him catch up to her on the road.",
            "next": 18
          },
          {
      ...
      "10": {
        ...
        "choices": [
          {
            "text": "Suggest meeting up for coffee this weekend.",
            "next": 20
          },
          {
      ...
      "13": {
        ...
        "choices": [
          {
            "text": "Check in on him a week later, gently.",
            "next": 26
          },
          {
            "text": "Wait and see if he reaches out first.",
            "next": 27
          }
        ]
      },
      "14": {
        ...
        "choices": [
          {
            "text": "Find him already there, waiting.",
            "next": 28
          },
          {
      ...
      "16": {
        ...
        "choices": [
          {
            "text": "He shows up, exactly when he said he would.",
            "next": 32
          },
          {
            "text": "Something comes up and he has to postpone.",
            "next": 33
          }
        ]
      },
  ...
  },
  {
    ...
    "passages": {
      "1": {
        ...
        "choices": [
          {
            "text": "Walk straight into the saloon and call him out",
            "next": 2
          },
          {
      ...
      "2": {
        ...
        "choices": [
          {
            "text": "Draw first \u2014 don't give him the chance",
            "next": 4
          },
          {
            "text": "Keep your hands still and try to talk him down",
            "next": 5
          }
        ]
      },
  ...
  },
  {
    ...
    "passages": {
      "1": {
        ...
        "choices": [
          {
            "text": "Duck into the bathroom to salvage what you can",
            "next": 2
          },
          {
            "text": "Walk in soaked and own it with confidence",
            "next": 3
          }
        ]
      },
      "2": {
        ...
        "choices": [
          ...
          {
            "text": "Say nothing and hope no one asks",
            "next": 5
          }
        ]
      },
...
const run = async () => {
  try {
    console.log("Seeding new stories into QuestTwyst database...");
    for (const story of stories) {
      await seedStory(story);
    }
    console.log("Done.");
  } catch (error) {
    console.error("Error seeding new stories:", error);
    process.exitCode = 1;
  } finally {
    await pool.end();
  }
